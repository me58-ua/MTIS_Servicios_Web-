...
2. Go to the generated directory you defined. There's a fully working NodeJS-ExpressJs server waiting for you. This is important - the code is yours to change and update! Look at config.js and see that the settings there are ok with you - the server will run on port 8081, and files will be uploaded to a new directory 'uploaded_files'.
...
http://localhost:8081/api-docs/. To
2. Download the openapi.yaml document: http://localhost:8081/openapi.
